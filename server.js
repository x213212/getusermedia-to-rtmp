...
// io.on('connection', function(socket){
	...
	// socket.on('start',function(m){
		...
		// var ops=[
			...
			// '-avoid_negative_ts','1',
			// '-benchmark',
			'rawvideo', socket._rtmpDestination
...
'-benchmark',
		...
		// ffmpeg_process.on('error',function(e){
			// console.log(new Date()+'child process error'+e);
			// socket.emit('fatal',+'ffmpeg error!'+e);
			// feedStream=false;
			// socket.disconnect();
		// });
		// ffmpeg_process.on('exit',function(e){
			// console.log(new Date()+'child process exit'+e);
	...
	// socket.on('binarystream',function(m){
		// if(!feedStream){
			// socket.emit('fatal','rtmp server not set yet.');
	...
	// socket.on('error',function(e){
		...
		// console.log(new Date()+' socket.io error:'+e);
	// });
// });
...
// server.listen(443, function(){
  // console.log(new Date()+' https and websocket listening on *:443');
// });
